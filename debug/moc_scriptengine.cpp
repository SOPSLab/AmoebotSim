...
QT_MOC_LITERAL(5, 28, 14), // "executeCommand"
QT_MOC_LITERAL(6, 43, 3), // "cmd"
QT_MOC_LITERAL(7, 47, 9), // "runScript"
QT_MOC_LITERAL(8, 57, 14) // "scriptFilePath"

    },
    "ScriptEngine\0log\0\0msg\0error\0executeCommand\0"
    "cmd\0runScript\0scriptFilePath"
};
...
void ScriptEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->runScript((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ScriptEngine::*_t)(const QString , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScriptEngine::log)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ScriptEngine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ScriptEngine.data,
