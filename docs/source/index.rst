...
If this describes you, refer to the :ref:`Installation Guide <install-explorer>` for instructions on downloading the most recent standalone version of AmoebotSim.
...
AmoebotSim is licensed under the `GNU General Public License v3.0 <https://choosealicense.com/licenses/gpl-3.0/>`_ in our attempts to keep research open.
