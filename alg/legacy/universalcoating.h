#ifndef AMOEBOTSIM_ALG_LEGACY_UNIVERSALCOATING
#define AMOEBOTSIM_ALG_LEGACY_UNIVERSALCOATING

#include <QColor>

#include "alg/legacy/algorithmwithflags.h"

class LegacySystem;  // legacy algorithm
...
#endif  // AMOEBOTSIM_ALG_LEGACY_UNIVERSALCOATING
